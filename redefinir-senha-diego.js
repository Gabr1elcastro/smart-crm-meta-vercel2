...
async function redefinirSenhaDiego() {
  console.log('🔐 Iniciando redefinição de senha para Diego...');
  
  try {
    // 1. Buscar usuário pelo email
    console.log('🔍 Buscando usuário: diego.almeida@basicobemfeito.com');
    ...
    const user = users.users.find(u => u.email === 'diego.almeida@basicobemfeito.com');
    ...
    // 2. Redefinir a senha
    console.log('🔄 Redefinindo senha para: 123456');
    ...
    console.log('📧 Email: diego.almeida@basicobemfeito.com');
