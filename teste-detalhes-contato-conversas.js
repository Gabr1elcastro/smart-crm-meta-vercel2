// Script para testar a funcionalidade de detalhes do contato na página de conversas
// Execute este script no console do navegador quando estiver na página /conversations

console.log('=== TESTE: Detalhes do Contato - Conversas ===');
...
// 3. Função para simular clique com botão direito em um contato
...
function verificarOpcoesMenu() {
  ...
  opcoes.forEach((opcao, index) => {
    ...
    if (texto.includes('Etiquetas')) {
      encontrouEtiquetas = true;
      console.log('✅ Seção "Etiquetas" encontrada');
    }
  });
...
// 8. Função para testar fechamento do modal
...
// 9. Função para verificar estrutura da página
function verificarEstrutura() {
  console.log('🏗️ Verificando estrutura da página...');
  
  // Verificar elementos principais
  const elementos = {
    'Lista de contatos': document.querySelector('[class*="ScrollArea"]'),
...
console.log('🚀 Iniciando testes de detalhes do contato...');
...
if (verificarContatos()) {
  ...
  setTimeout(() => {
    ...
    console.log('✅ Menu de contexto testado');
